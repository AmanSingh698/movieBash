        ...
        <div class="container">
            <div class="header-content flex-between">
                ...
                <div class="header-actions">
                    ...
                    <button v-if="!userToken" class="btn btn-primary btn-sm" @click="openSignInModal">Sign In</button>
                    <button v-else class="btn btn-primary btn-sm" @click="openSignInModal">Sign Out</button>
                </div>
...
const getToken = async () => {
    const token = await store.getters['auth/authToken']
    console.log(token);
